...
sub Authenticate
  ...
  AE::log info => 'before final pass vs dbpass check';
  if ($password eq $dbpass)
    {
    # Full permissions for a user+pass authentication
    AE::log info => '- - - Dopey pass eq dbpass function';
